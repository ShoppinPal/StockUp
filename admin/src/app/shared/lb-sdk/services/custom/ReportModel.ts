...
/**
 * Api services for the `ReportModel` model.
 */
@Injectable()
export class ReportModelApi extends BaseLoopBackApi {
  ...
  public getStoreConfigModel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/storeConfigModel";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Fetches belongsTo relation storeModel.
   *
   * @param {any} id ReportModel id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getStoreModel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/storeModel";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Fetches belongsTo relation categoryModel.
   *
   * @param {any} id ReportModel id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getCategoryModel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/categoryModel";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public countStockOrderLineitemModels(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/stockOrderLineitemModels/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getWorkerStatus(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/getWorkerStatus";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public generateStockOrderReportForManager(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/generateStockOrderReportForManager";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getRows(id: any, pageSize: any = {}, pageNumber: any = {}, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/getRows";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof pageSize !== 'undefined' && pageSize !== null) _urlParams.pageSize = pageSize;
    if (typeof pageNumber !== 'undefined' && pageNumber !== null) _urlParams.pageNumber = pageNumber;
    if (typeof where !== 'undefined' && where !== null) _urlParams.where = where;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * This method returns no data.
   */
  public updateRows(id: any, rows: any, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/updateRows";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * This method returns no data.
   */
  public removeReport(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/remove";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public lookupAndAddProductBySku(id: any, sku: any, boxNumber: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/lookupAndAddProductBySku";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof sku !== 'undefined' && sku !== null) _urlParams.sku = sku;
    if (typeof boxNumber !== 'undefined' && boxNumber !== null) _urlParams.boxNumber = boxNumber;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public setReportStatus(id: any, from: any, to: any, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ReportModels/:id/setReportStatus";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
