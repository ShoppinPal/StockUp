...
export class UserModelApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public updateByIdStoreConfigModels(id: any, fk: any, data: StoreConfigModel = new StoreConfigModel(), customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UserModels/:id/storeConfigModels/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createStoreConfigModels(id: any, data: StoreConfigModel = new StoreConfigModel(), customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UserModels/:id/storeConfigModels";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyStoreConfigModels(id: any, data: StoreConfigModel[] = new Array<StoreConfigModel>(), customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UserModels/:id/storeConfigModels";
    let _routeParams: any = {
