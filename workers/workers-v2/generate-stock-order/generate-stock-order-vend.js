                ...
                try {
                    ...
                    _.each(productInstances, function (eachProduct) {
                        ...
                        if (useRow) {
                            ...
                            let isApproved = supplier.reportDefaultState ? approvedStates.includes(supplier.reportDefaultState) || null : null;
                            let isFulfilled = supplier.reportDefaultState ? fulfilledStates.includes(supplier.reportDefaultState) || null : null;
