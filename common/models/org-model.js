...
module.exports = function (OrgModel) {
    OrgModel.on("dataSourceAttached", function (obj) {
        ...
        OrgModel = Promise.promisifyAll(OrgModel, {
        ...
        OrgModel.fetchAuthorizationUrl = function (
            id,
            integrationType,
            options,
            cb
            ...
            return OrgModel.app.models.IntegrationModel.fetchAuthorizationUrl(
                integrationType,
                options
            ).catch(function (error) {
                logger.error({
                    message:
                        "Error fetching authorization url for integration type",
                    integrationType,
                    functionName: "fetchAuthorizationUrl",
                    options,
                });
            ...
            if (error) {
                ...
                return vendSdk
                    .getInitialAccessToken(
                        ...
                        OrgModel.app.get("site").baseUrl +
                        "/api/OrgModels/handleVendToken",
                        code,
                        domainPrefix,
                        state
                    )
                    ...
                    .then(function (response) {
                        logger.debug({
                            message:
                                "Fetched access token and refresh token, will store in org model",
                            functionName: "handleVendToken",
                        });
                        if (response && response.access_token) {
                            ...
                            logger.debug({
                                message:
                                    "Looking for the user and org for access token stored in state param",
                            });
                            return OrgModel.app.models.AccessToken.findById(
                                state
                            );
                        } else {
                            logger.error({
                            ...
                            return Promise.reject(
                                "Some error in fetching access token"
                            );
                        }
                    })
                    .catch(function (error) {
                        logger.error({
                            error,
                            message:
                                "Error in validating access token from state param",
                            functionName: "handleVendToken",
                        });
                        return Promise.reject(error);
                    })
                    .then(function (accessToken) {
                        ...
                        return OrgModel.app.models.UserModel.findById(
                            accessToken.userId
                        );
                    })
                    .then(function (userModelInstance) {
                        ...
                        return OrgModel.app.models.IntegrationModel.create(
                            vendToken
                        );
                    })
                    .catch(function (error) {
                        logger.error({
                            error,
                            message:
                                "Error in storing access token received from vend",
                            functionName: "handleVendToken",
                        });
                        return Promise.reject(error);
                    });
        ...
        OrgModel.afterRemote(
            "handleVendToken",
            function (context, remoteMethodOutput, next) {
                logger.debug({
                    message:
                        "Handled vend token, now will redirect to connect POS/ERP page",
        ...
        OrgModel.afterRemote(
            ...
            function (context, remoteMethodOutput, next) {
                logger.debug({
                    message:
                        "Handled MSD token, now will redirect to connect POS/ERP page",
        ...
        //If someone changes this url, also remember to change it in MSD and IntegrationModel.fetchIntegrationUrl()
        OrgModel.handleMSDToken = function (
            code,
            sessionState,
            state,
            error,
            ...
            if (error) {
                ...
                return rp({
                    ...
                    .then(
                        ...
                        function (error) {
                            logger.error({
                                ...
                                message:
                                    "Error in fetching access token from MSD",
                                functionName: "handleMSDToken",
                            });
                            return Promise.reject(error);
                        }
                    ...
                    .then(function (userModelInstance) {
                        ...
                        return OrgModel.app.models.IntegrationModel.findOne({
                            where: { orgModelId: userModelInstance.orgModelId },
                        });
                    })
                    .then(function (integrationModelInstance) {
                        ...
                        if (!integrationModelInstance) {
                            ...
                            return integrationModelInstance.updateAttributes(
                                msdToken
                            );
                        }
                    })
                    .catch(function (error) {
                        logger.error({
                            error,
                            message:
                                "Error in storing access token received from MSD",
                            functionName: "handleMSDToken",
                        });
                        return Promise.reject(error);
                    })
                    .then(function (result) {
                        logger.debug({
                            message:
                                "Created integration model, will look for companies in MSD",
                            result,
                            functionName: "handleMSDToken",
                        });
                        var MSDUtil = require("./../utils/msd")({
                            GlobalOrgModel: OrgModel,
                        });
                        return MSDUtil.fetchMSDData(
                            msdToken.orgModelId,
                            "DimAttributeCompanyInfos"
                        );
                    })
                    .catch(function (error) {
                        logger.error({
                        ...
                        return Promise.reject(
                            "Could not fetch companies from MSD"
                        );
                    })
                    ...
                    .catch(function (error) {
                        ...
                        return Promise.reject(
                            "Could not save company data into DB"
                        );
                    });
            }
        };
        ...
        OrgModel.initiateVendSync = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.initiateVendSync(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.initiateMSDSync = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.initiateMSDSync(
                id,
                options
            ).catch(function (error) {
                logger.error({
            ...
            return Promise.resolve()
                ...
                .then(function (res) {
                    logger.debug({
                        databaseName,
                        message:
                            "Closed present sql connections, will try connecting to given database",
                        options,
                        sqlConfig,
                        functionName: "validateMSSQLDatabase",
                    });
                ...
                .then(function (res) {
                    logger.debug({
                        message:
                            "Database connected successfully, will update in Integration Model",
                        functionName: "validateMSSQLDatabase",
                        options,
                    });
                    return OrgModel.app.models.IntegrationModel.updateAll(
                ...
                .then(function (res) {
                    logger.debug({
                        message:
                            "Database valid flag updated in Integration Model",
                        res,
                        functionName: "validateMSSQLDatabase",
                        options,
                    });
        ...
        OrgModel.stopMSDSync = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.stopMSDSync(id, options).catch(
                function (error) {
                    logger.error({
        ...
        OrgModel.syncMSDUsers = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.syncMSDUsers(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.syncMSDStores = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.syncMSDStores(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.syncMSDCategories = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.syncMSDCategories(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.updateBinLocation = function (
            id,
            productId,
            binLocation,
            options
        ) {
            return OrgModel.app.models.ProductModel.updateBinLocation(
                id,
                productId,
                binLocation,
                options
        ...
        OrgModel.uploadMinMaxFile = function (id, req, options, cb) {
            ...
            return OrgModel.app.models.CategoryModel.uploadMinMaxFile(
                id,
                req,
                options
            ).catch(function (error) {
        ...
        OrgModel.generateStockOrderMSD = function (
            id,
            storeModelId,
            warehouseModelId,
            categoryModelId,
            ...
            if (scheduled) {
                ...
                return OrgModel.app.models.ReportModel.generateStockOrderMSD(
                    id,
                    storeModelId,
                    warehouseModelId,
                    categoryModelId,
                    ...
                    return Promise.reject(
                        "Could not initiate stock order generation"
                    );
                });
            }
        };
        ...
        OrgModel.generateStockOrderVend = function (
            id,
            storeModelId,
            supplierModelId,
            name,
            ...
            if (scheduled) {
                ...
                return OrgModel.app.models.ReportModel.generateStockOrderVend(
                    id,
                    storeModelId,
                    supplierModelId,
                    name,
        ...
        OrgModel.receiveConsignment = function (
            id,
            reportModelId,
            sendEmail,
            res,
            ...
            return OrgModel.app.models.ReportModel.receiveConsignment(
                id,
                reportModelId,
                sendEmail,
                res,
                ...
                return Promise.reject(
                    "Could not initiate stock order receiving"
                );
            });
        };
        ...
        OrgModel.createTransferOrderMSD = function (
            id,
            reportModelId,
            sendEmail,
            emailData,
            ...
            if (sendEmail === true) {
                OrgModel.app.models.ReportModel.sendReportAsEmail(
                    reportModelId,
                    emailData.to,
                    emailData.cc,
                    emailData.bcc,
                    ...
                    .then(function () {
                        return OrgModel.app.models.ReportModel.createTransferOrderMSD(
                            id,
                            reportModelId,
                            res,
                            options
                    ...
                    .catch(function (error) {
                        ...
                        return Promise.reject(
                            "Could not create transfer order in MSD"
                        );
                    });
            } else {
                OrgModel.app.models.ReportModel.createTransferOrderMSD(
                    id,
                    reportModelId,
                    res,
                    options
        ...
        OrgModel.remoteMethod("updateAllStockOrderLineItemModels", {
            ...
            http: {
                path: "/:id/updateAllStockOrderLineItemModels",
                verb: "POST",
            },
            returns: { arg: "status", type: "object", root: true },
        });

        OrgModel.updateAllStockOrderLineItemModels = function (
            id,
            reportModelId,
            lineItemIds,
            data,
            ...
            return OrgModel.app.models.StockOrderLineitemModel.updateAll(
                ...
                return Promise.reject(
                    "Could not update stock order line items"
                );
            });
        };
        ...
        OrgModel.syncVendStores = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.syncVendStores(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.syncVendUsers = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.syncVendUsers(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.syncVendProductTypes = function (id, options, cb) {
            ...
            return OrgModel.app.models.SyncModel.syncVendProductTypes(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.inviteUser = function (id, userId, options) {
            return OrgModel.app.models.UserModel.inviteUser(
                id,
                userId,
                options
            ).catch(function (error) {
        ...
        OrgModel.fetchOrderRowCounts = function (id, orderIds, options) {
            return OrgModel.app.models.ReportModel.fetchOrderRowCounts(
                orderIds,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.downloadReportModelCSV = function (
            id,
            reportModelId,
            options
        ) {
            return OrgModel.app.models.ReportModel.downloadReportModelCSV(
                id,
                reportModelId,
                options
            ).catch(function (error) {
        ...
        OrgModel.remoteMethod("setReportStatus", {
            ...
            returns: {
                arg: "updatedReportModelInstance",
                type: "object",
                root: true,
            },
        });
        ...
        OrgModel.setReportStatus = function (id, reportModelId, to, options) {
            return OrgModel.app.models.ReportModel.setReportStatus(
                id,
                reportModelId,
                to,
                options
        ...
        OrgModel.createPurchaseOrderVend = function (
            id,
            reportModelId,
            sendEmail,
            emailData,
            ...
            if (sendEmail === true) {
                OrgModel.app.models.ReportModel.sendReportAsEmail(
                    ...
                    .then(function () {
                        return OrgModel.app.models.ReportModel.createPurchaseOrderVend(
                            id,
                            reportModelId,
                            res,
                            options
                    ...
                    .catch(function (error) {
                        ...
                        return Promise.reject(
                            "Could not create purchase order in Vend"
                        );
                    });
            } else {
                OrgModel.app.models.ReportModel.createPurchaseOrderVend(
                    id,
                    reportModelId,
                    res,
                    options
        ...
        OrgModel.assignRoles = function (id, userId, roles, options) {
            return OrgModel.app.models.UserModel.assignRoles(
                userId,
                roles
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.assignStoreModelsToUser = function (
            id,
            userId,
            storeIds,
            role,
            ...
            return OrgModel.app.models.UserModel.assignStoreModelsToUser(
                id,
                userId,
                storeIds,
                role,
        ...
        OrgModel.sendConsignmentDelivery = function (
            id,
            reportModelId,
            options
        ) {
            return OrgModel.app.models.ReportModel.sendConsignmentDelivery(
                id,
                reportModelId,
                options
            ).catch(function (error) {
        ...
        OrgModel.scanBarcodeStockOrder = function (
            id,
            scanType,
            productSku,
            reportModelId,
            ...
            return OrgModel.app.models.StockOrderLineitemModel.scanBarcodeStockOrder(
                scanType,
                productSku,
                id,
                reportModelId,
        ...
        OrgModel.fetchFileImportHeaders = function (id, options) {
            return OrgModel.app.models.OrderConfigModel.fetchFileImportHeaders(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.importVendOrderFromFile = function (
            id,
            req,
            res,
            options,
            ...
            return OrgModel.app.models.ReportModel.importVendOrderFromFile(
                id,
                req,
                res,
                options
        ...
        OrgModel.setDesiredStockLevelForVend = function (
            id,
            storeModelId,
            productModelId,
            desiredStockLevel,
            ...
            return OrgModel.app.models.ProductModel.setDesiredStockLevelForVend(
                id,
                storeModelId,
                productModelId,
                desiredStockLevel,
        ...
        OrgModel.editSupplierStoreMappings = function (id, mappings, options) {
            ...
            return OrgModel.app.models.SupplierStoreMapping.editSupplierStoreMappings(
                id,
                mappings,
                options
            ).catch(function (error) {
        ...
        OrgModel.assignStoreToSupplier = function (
            id,
            storeModelId,
            supplierModelId,
            options
        ) {
            return OrgModel.app.models.StoreModel.assignStoreToSupplier(
                id,
                storeModelId,
                supplierModelId,
                options
        ...
        OrgModel.deleteStockOrderVend = function (id, orderId, options) {
            return OrgModel.app.models.ReportModel.deleteStockOrderVend(
                id,
                orderId,
                options
            ).catch(function (error) {
        ...
        OrgModel.addProductToStockOrder = function (
            id,
            reportModelId,
            storeModelId,
            product,
            ...
            return OrgModel.app.models.ReportModel.addProductToStockOrder(
                id,
                reportModelId,
                storeModelId,
                product,
        ...
        OrgModel.remoteMethod("uploadReorderPointsMultiplierFile", {
            ...
            http: {
                path: "/:id/uploadReorderPointsMultiplierFile",
                verb: "post",
            },
            returns: { arg: "result", type: "string" },
        });

        OrgModel.uploadReorderPointsMultiplierFile = function (
            id,
            req,
            options,
            cb
            ...
            logger.debug({
                message:
                    "Will upload reorder points multiplier file for products",
                functionName: "uploadReorderPointsMultiplierFile",
                options,
            });
            return OrgModel.app.models.ReorderPointsMultiplierModel.uploadReorderPointsMultiplierFile(
                id,
                req,
                options
            ).catch(function (error) {
        ...
        OrgModel.remoteMethod("downloadSampleReorderPointsMultiplierFile", {
            ...
            http: {
                path: "/:id/downloadSampleReorderPointsMultiplierFile",
                verb: "GET",
            },
            returns: { arg: "csvReportUrl", type: "string", root: true },
        });

        OrgModel.downloadSampleReorderPointsMultiplierFile = function (
            id,
            options
        ) {
            return OrgModel.app.models.ReorderPointsMultiplierModel.downloadSampleFile(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.remoteMethod("downloadReorderPointsMultiplierFile", {
            ...
            http: {
                path: "/:id/downloadReorderPointsMultiplierFile",
                verb: "GET",
            },
            returns: { arg: "csvReportUrl", type: "string", root: true },
        });

        OrgModel.downloadReorderPointsMultiplierFile = function (
            id,
            multiplierId,
            options
        ) {
            return OrgModel.app.models.ReorderPointsMultiplierModel.downloadReorderPointsMultiplierFile(
                id,
                multiplierId,
                options
            ).catch(function (error) {
        ...
        OrgModel.downloadMinMaxFile = function (id, multiplierId, options) {
            return OrgModel.app.models.CategoryModel.downloadMinMaxFile(
                id,
                options
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.remoteMethod("getDiscrepancyOrBackOrderedLineItems", {
            ...
            http: {
                path: "/:id/getDiscrepancyOrBackOrderedLineItems",
                verb: "GET",
            },
            returns: { arg: "result", type: "array", root: true },
        });

        OrgModel.getDiscrepancyOrBackOrderedLineItems = function (
            id,
            reportId,
            filters
        ) {
            return OrgModel.app.models.ReportModel.getDiscrepancyOrBackOrderedLineItems(
                id,
                reportId,
                filters
            ).catch(function (error) {
        ...
        OrgModel.userProfile = function (id, userId, options) {
            return OrgModel.app.models.UserModel.profile(userId, options).catch(
                function (error) {
                    logger.error({
                        error,
        ...
        OrgModel.fulfillAllLineItems = function (id, reportModelId) {
            return OrgModel.app.models.ReportModel.fulfillAllLineItems(
                id,
                reportModelId
            ).catch(function (error) {
                logger.error({
        ...
        OrgModel.getReportAnchors = function (
            id,
            reportId,
            query,
            showBinLocations
        ) {
            return OrgModel.app.models.ReportModel.getReportAnchors(
                id,
                reportId,
                query,
                showBinLocations
