        ...
        if (currentUser) {
            StockOrderLineitemModel.findById(id) // chain the promise via a return statement so unexpected rejections/errors float up
                .then(function (stockOrderLineitemModelInstance) {
                        ...
                        logger.debug({
                            log: {
                                message: `${methodName} > findById > then`,
                                stockOrderLineitemModelInstance: stockOrderLineitemModelInstance
                            }
                        });
                        ...
                        logger.debug({
                            log: {
                                message: `${methodName} > findById > then > extending StockOrderLineitemModel with attributes`,
                        ...
                        logger.debug({
                            log: {
                                message: `${methodName} > findById > then > extended StockOrderLineitemModel`,
